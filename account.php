  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/rama.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="CSE SECTION C" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">C SECTION</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">SJEC VAMANJOOR</h4>
